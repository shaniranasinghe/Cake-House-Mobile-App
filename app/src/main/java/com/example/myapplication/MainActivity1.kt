...
class MainActivity1 : AppCompatActivity() {
    ...
    private fun saveNoteToInternalStorage() {
        val filename = "notes.txt"
        val fileContents = "Date: $selectedDate\nTime: $selectedTime\n\n"
        try {
    ...
    private fun scheduleReminderNotification() {
        ...
        if (triggerTime > System.currentTimeMillis()) {
            ...
            val intent = Intent(this, NotificationReceiver::class.java).apply {
                putExtra("title", "Successful")
                putExtra("description", "Your order is successful... We will deliver your order soon")
            }
...
class NotificationReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        val notification = NotificationCompat.Builder(context, "ReminderChannel")
            ...
            .setContentText("Your order is successful... We will deliver your order soon")
